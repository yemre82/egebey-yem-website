          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="absolute top-4 right-4 w-10 h-10 rounded-full bg-black/20 hover:bg-black/40 flex items-center justify-center text-white transition-colors cursor-pointer"
              >
                <IoClose size={24} />
              </motion.button>
            </motion.div>
